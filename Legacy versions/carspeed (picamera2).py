...
def processCameraImage():
    global state, last_x, initial_x, initial_time, last_mph, base_image, text_on_image
...
#for frame in camercreate a a.capture_continuous(rawCapture, format="bgr", use_video_port=True):
cont = True
while cont:
    ...
    #python while statementrawCapture.truncate(0)
    time.sleep(0.0333)
